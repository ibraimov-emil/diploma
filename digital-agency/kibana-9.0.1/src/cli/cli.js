...
program.version(_repoInfo.kibanaPackageJson.version).description('Kibana is an open source, browser based analytics and search dashboard for Elasticsearch.');
