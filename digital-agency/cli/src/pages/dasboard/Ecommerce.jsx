            ...
            <div className="flex flex-wrap lg:flex-nowrap ">
                <div className="flex m-3 flex-wrap gap-1 items-center">
                    ...
                    <div
                        ...
                        <p className="mt-3">
                            <span className="text-lg font-semibold">{statCounts.tasksCompleted}</span>
                        </p>
                    ...
                    <div
                        ...
                        <p className="mt-3">
                            <span className="text-lg font-semibold">{statCounts.tasksProcessed}</span>
                        </p>
                    ...
                    <div
                        ...
                        <p className="mt-3">
                            <span className="text-lg font-semibold">{statCounts.tasksСons}</span>
                        </p>
