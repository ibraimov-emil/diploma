...
import Html from '../../data/skills/html.png';
import Css from '../../data/skills/css.png';
import Javascript from '../../data/skills/javascript.png';
import ReactImg from '../../data/skills/react.png';
import Tailwind from '../../data/skills/tailwind.png';
import Github from '../../data/skills/github1.png';
import Firebase from '../../data/skills/firebase.png';
import NextJS from '../../data/skills/nextjs.png'
import AWS from '../../data/skills/aws.png';
  ...
  return (
    <div id='skills' className='w-full lg:h-screen p-2'>
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <h2 className='py-4'>Что мы умеем</h2>
